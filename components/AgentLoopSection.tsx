      ...
      <div className="w-full max-w-6xl mx-auto px-8 lg:px-16">
          ...
          {steps.map((step, idx) => (
            <FadeIn key={idx} delay={0.1 * idx}>
              <div className="flex gap-8 items-start mb-8 group">
                <span className="text-2xl font-mono text-[#ccc] group-hover:text-[#111] transition-colors mt-1">
                  {(idx + 1).toString().padStart(2, '0')}
                </span>
                <p className="text-xl lg:text-2xl text-[#666] group-hover:text-[#111] transition-colors leading-relaxed font-sans">
                  {step}
                </p>
              </div>
            </FadeIn>
        ...
        <FadeIn delay={0.4}>
          <div className="mt-32 bg-[#111] p-10 lg:p-24 text-center text-white relative overflow-hidden">
            ...
            <p className="text-2xl lg:text-3xl leading-relaxed font-serif italic max-w-4xl mx-auto relative z-10 text-[#eee]">
