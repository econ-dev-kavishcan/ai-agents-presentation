      ...
      <div className="w-full max-w-6xl mx-auto px-8 lg:px-16">
        ...
        <FadeIn delay={0.1}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-[#e5e5e5] pt-16 mt-16">
            <div className="lg:col-span-4">
              <h3 className="text-4xl font-serif">Single Agent</h3>
              <p className="mt-4 text-[#666] text-xl leading-relaxed">
            ...
            <div className="lg:col-span-8 bg-white border border-[#e5e5e5] p-12 flex justify-center items-center shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
               <div className="flex flex-col items-center gap-6">
                 ...
                 <div className="text-base font-mono tracking-widest uppercase text-[#888]">Centralized Core</div>
               </div>
            </div>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.2}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-[#e5e5e5] pt-16 mt-16">
            <div className="lg:col-span-4 lg:order-last">
              <h3 className="text-4xl font-serif">Router Pattern</h3>
              <p className="mt-4 text-[#666] text-xl leading-relaxed">
            ...
            <div className="lg:col-span-8 bg-white border border-[#e5e5e5] p-12 flex justify-center items-center shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
               <div className="flex flex-col items-center gap-8 w-full max-w-md">
                 <div className="w-full p-4 border border-[#333] text-center font-serif text-2xl">
                   Router
                 </div>
                 <div className="w-px h-8 bg-border-subtle"></div>
                 <div className="grid grid-cols-3 gap-4 w-full">
                   <div className="p-4 border border-[#e5e5e5] text-center font-sans text-base text-[#666]">Research</div>
                   <div className="p-4 border border-[#e5e5e5] text-center font-sans text-base text-[#666]">Coding</div>
                   <div className="p-4 border border-[#e5e5e5] text-center font-sans text-base text-[#666]">Analysis</div>
                 </div>
               </div>
            </div>
          </div>
        ...
        <FadeIn delay={0.3}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-[#e5e5e5] pt-24 mt-24">
            <div>
              <h4 className="text-base font-sans tracking-widest uppercase text-[#111] mb-8 border-b border-[#e5e5e5] pb-4">01. Design Principles</h4>
              <ul className="flex flex-col gap-6 text-xl text-[#666] list-none">
            ...
            <div>
              <h4 className="text-base font-sans tracking-widest uppercase text-[#111] mb-8 border-b border-[#e5e5e5] pb-4">02. Production Readiness</h4>
              <ul className="flex flex-col gap-6 text-xl text-[#666] list-none">
