        ...
        <FadeIn>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            <div className="lg:col-span-6">
              ...
              <h2 className="text-[3.5rem] lg:text-[4.5rem] leading-none tracking-[-0.03em] font-serif mb-8 text-white">
                Agents &amp;<br />
                <span className="italic text-[#888]">External Systems</span>
              </h2>
              <div className="border-l border-[#333] pl-6">
                <p className="text-2xl text-[#ccc] leading-relaxed font-serif">
            ...
            <div className="lg:col-span-6 flex flex-col gap-px bg-[#333] border border-[#333]">
              <div className="bg-[#1a1a1a] p-10 lg:p-12 hover:bg-[#222] transition-colors flex items-center gap-8 group">
                <span className="text-5xl font-mono text-[#444] group-hover:text-white transition-colors">01</span>
                <h3 className="text-4xl font-sans font-medium text-white!">Memory &amp; Data Access</h3>
              </div>
              <div className="bg-[#1a1a1a] p-10 lg:p-12 hover:bg-[#222] transition-colors flex items-center gap-8 group">
                <span className="text-5xl font-mono text-[#444] group-hover:text-white transition-colors">02</span>
                <h3 className="text-4xl font-sans font-medium text-white!">Tools and Integrations</h3>
              </div>
              <div className="bg-[#1a1a1a] p-10 lg:p-12 hover:bg-[#222] transition-colors flex items-center gap-8 group">
                <span className="text-5xl font-mono text-[#444] group-hover:text-white transition-colors">03</span>
                <h3 className="text-4xl font-sans font-medium text-white!">Models</h3>
              </div>
            </div>
          </div>
        </FadeIn>
