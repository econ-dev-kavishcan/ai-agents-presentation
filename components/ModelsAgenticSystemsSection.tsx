        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-[#e5e5e5] border border-[#e5e5e5] mb-24">
          <FadeIn delay={0.1} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-2xl font-sans font-medium mb-4 text-[#111]">Frontier Models</h3>
          ...
          <FadeIn delay={0.2} className="h-full lg:col-span-1">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-2xl font-sans font-medium mb-4 text-[#111]">Multi-Model Agents</h3>
              <ul className="list-disc pl-6 flex flex-col gap-3 text-[#666] text-lg leading-relaxed marker:text-[#ccc]">
          ...
          <FadeIn delay={0.3} className="h-full lg:col-span-2">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors h-full">
              ...
              <h3 className="text-2xl font-sans font-medium mb-8 text-[#111]">Local Models</h3>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
                <ul className="list-disc pl-6 flex flex-col gap-4 text-[#666] text-lg leading-relaxed marker:text-[#ccc]">
                ...
                <div>
                  <p className="text-[#666] text-lg leading-relaxed mb-4">Require operational practices such as:</p>
