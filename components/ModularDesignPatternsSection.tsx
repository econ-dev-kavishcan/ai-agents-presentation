        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#e5e5e5] border border-[#e5e5e5]">
          <FadeIn delay={0.1} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-3xl font-sans font-medium mb-4 text-[#111]">Single-Responsibility Agents</h3>
          ...
          <FadeIn delay={0.2} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-3xl font-sans font-medium mb-4 text-[#111]">Clean Tool Boundaries</h3>
              <ul className="list-disc pl-6 flex flex-col gap-3 text-[#666] text-xl leading-relaxed marker:text-[#ccc]">
          ...
          <FadeIn delay={0.3} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-3xl font-sans font-medium mb-4 text-[#111]">Tool-First Design</h3>
              <ul className="list-disc pl-6 flex flex-col gap-3 text-[#666] text-xl leading-relaxed marker:text-[#ccc]">
