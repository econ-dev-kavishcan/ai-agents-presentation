            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="border-b-2 border-[#111]">
                  <th className="py-6 px-4 font-sans font-medium text-[#111] text-xl w-[30%]">Pattern</th>
                  <th className="py-6 px-4 font-sans font-medium text-[#111] text-xl w-[45%]">What It Does</th>
                  <th className="py-6 px-4 font-sans font-medium text-[#111] text-xl w-[25%]">Well-Architected Pillar</th>
                </tr>
              </thead>
              <tbody>
                {tableData.map((row, idx) => (
                  <tr key={idx} className="border-b border-[#e5e5e5] hover:bg-[#fafafa] transition-colors">
                    ...
                    <td className="py-6 px-4 font-serif text-[#666] text-xl">{row.whatItDoes}</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#e5e5e5] border border-[#e5e5e5]">
          <FadeIn delay={0.3} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-3xl font-sans font-medium mb-4 text-[#111]">Cost Optimization</h3>
          ...
          <FadeIn delay={0.4} className="h-full">
            <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
              ...
              <h3 className="text-3xl font-sans font-medium mb-4 text-[#111]">Performance Efficiency</h3>
              <ul className="list-disc pl-6 flex flex-col gap-3 text-[#666] text-xl leading-relaxed marker:text-[#ccc]">
