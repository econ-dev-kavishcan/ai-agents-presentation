        ...
        <FadeIn>
          <div className="mb-24">
            ...
            <h2 className="text-[3.5rem] lg:text-[5rem] leading-none tracking-[-0.03em] font-serif max-w-4xl text-[#111]">
              ...
              <span className="text-5xl lg:text-6xl text-[#888] block mt-4">(External Integrations)</span>
            </h2>
          ...
          <div className="mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#e5e5e5] border border-[#e5e5e5]">
              <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
                ...
                <h4 className="text-3xl font-sans font-medium mb-4 text-[#111]">JSON Schemas</h4>
                <p className="text-[#666] text-xl leading-relaxed">Tools are defined using JSON schemas that describe exactly when and how they should be used.</p>
              </div>

              <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
                <CheckCircle className="text-[#888] mb-8" size={32} strokeWidth={1.5} />
                <h4 className="text-3xl font-sans font-medium mb-4 text-[#111]">Well-designed tools</h4>
                <p className="text-[#666] text-xl leading-relaxed">Precise definitions improve accuracy, reduce latency, and lower computational cost significantly.</p>
              </div>

              <div className="bg-white p-10 hover:bg-[#fafafa] transition-colors flex flex-col h-full">
                <XCircle className="text-[#888] mb-8" size={32} strokeWidth={1.5} />
                <h4 className="text-3xl font-sans font-medium mb-4 text-[#111]">Poorly defined schemas</h4>
                <p className="text-[#666] text-xl leading-relaxed">Can lead to incorrect tool selection and unnecessary context window expansion.</p>
              </div>
            </div>
          </div>
        </FadeIn>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-[#333] border border-[#333]">
              <div className="bg-[#111] p-10 lg:p-12 hover:bg-[#1a1a1a] transition-colors flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="text-4xl font-sans font-medium mb-4 text-white!">Model Context Protocol (MCP)</h4>
                </div>
                <p className="text-[#ccc] text-xl leading-relaxed">Introduced by Anthropic, MCP is an open standard for securely connecting AI systems with external tools and data sources.</p>
              </div>

              <div className="bg-[#111] p-10 lg:p-12 hover:bg-[#1a1a1a] transition-colors flex flex-col justify-between">
                <div>
                  <Network className="text-[#666] mb-8" size={36} strokeWidth={1.5} />
                  <h4 className="text-4xl font-sans font-medium mb-4 text-white!">Agent-to-Agent (A2A)</h4>
                </div>
                <p className="text-[#ccc] text-xl leading-relaxed">Protocols that enable robust communication and coordination between multiple AI agents in distributed systems.</p>
              </div>
            </div>
          </div>
        </FadeIn>
